...
rails g scaffold Address id:integer street:string{50} city:string{50} country:string{50} addressable:reference adressable_type:string{50}
...
rails g scaffold Organization id:integer name:string{50}
...
rails g scaffold User id:integer first_name:string{255} last_name:string{255} role:references organization:references
