...
class TrialsControllerTest < ActionController::TestCase
  ...
  test "should create trial" do
    assert_difference('Trial.count') do
      post :create, trial: { description: @trial.description, id: @trial.id, name: @trial.name, summary: @trial.summary }
    end
  ...
  test "should update trial" do
    patch :update, id: @trial, trial: { description: @trial.description, id: @trial.id, name: @trial.name, summary: @trial.summary }
    assert_redirected_to trial_path(assigns(:trial))
  end
